...
public class WxLoginController {
    ...
    public String toLogin(){
        return "redirect:https://open.weixin.qq.com/connect/oauth2/authorize?appid="+AppId+"&redirect_uri=https%3a%2f%2fwww.klny.xyz%2fwx%2flogin-by-code&response_type=code&scope=snsapi_userinfo&state=vote#wechat_redirect";
